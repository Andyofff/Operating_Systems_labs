...
int main() {
	...
	char buffer[100];
	std::string commandLineStr = "";// for starting process Creator.exe
	...
	if (!CreateProcess(L"F:\\ОСи\\lab1\\lab1\\x64\\Debug\\Creator.exe", commandLine, NULL, NULL, FALSE, NULL, NULL, NULL, &siCreator, &piCreator)) {
	...
	if (!CreateProcess(L"F:\\ОСи\\lab1\\lab1\\x64\\Debug\\Reporter.exe", commandLine2, NULL, NULL, FALSE, NULL, NULL, NULL, &siReporter, &piReporter)) {
		std::cout << "ERROR: PROCESS IS NOT CREATED\n";
		return GetLastError();
	}
